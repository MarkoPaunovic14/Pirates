...
uniform PointLight pointLight5; // house
uniform PointLight pointLight6; // fire
...
void main()
{
    ...
    vec4 result = CalcPointLight(pointLight1, normal, FragPos, viewDir) +
                                      ...
                                      CalcPointLight(pointLight6, normal, FragPos, viewDir) +
